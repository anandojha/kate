...
def main():
    ...
    print("  Both slow processes recover in the right order, separated from fast")
    print("  (~3-frame) relaxation. The consistent ~3x underestimate is the")
    print("  discretization/finite-lag bias (Prinz et al.), corrected by a lag")
    print("  scan. The artifact stores the run-aware COUNT matrix, so production")
    print("  kinetics run a reversible-MLE MSM on it directly -- still no decode.")
    print("=" * 66)
