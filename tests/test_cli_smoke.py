...
CLI dispatch (argparse -> cmd_* -> run_glide/run_benchmark) was previously not exercised:
...
def test_cli_benchmark_smoke(tmp_path):
    ...
    # glide + a local pseudo-baseline -> no external tool, no torch needed
    main(["benchmark", pdb, dcd, "--methods", "glide,shuffle", "--lag", "10",
