...
CLI dispatch (argparse -> cmd_* -> run_epc/run_benchmark) was previously not exercised:
...
def test_cli_benchmark_smoke(tmp_path):
    ...
    # epc + a local pseudo-baseline -> no external tool, no torch needed
    main(["benchmark", pdb, dcd, "--methods", "epc,shuffle", "--lag", "10",
