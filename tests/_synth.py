...
from kate.kinetic_codec import count_matrix, transition_matrix
...
def kinetics_artifact(n_steps=3000, n_atoms=8, nstates=40, lag=10, seed=0):
    ...
    TICA + k-means on a metastable trajectory) -- enough to exercise `kate analyze`."""
    from kate.kinetic_codec import (kabsch_align, TICA, discretize, count_matrix,
                                   transition_matrix)
...
def toy_artifact(n=20000, a=0.02, seed=0):
    ...
    exercise `kate bound` / save / load without training anything."""
